...
# /**
#  * @file        Dockerfile
#  * @module      Thinklab Hash Token Registry Service Container Packaging Manifest
#  * @version     4.0.0
...
LABEL version="4.0.0"
LABEL description="Thinklab Hash Token Registry Service - Reactive Micronaut 4 runtime (reference implementation)"
